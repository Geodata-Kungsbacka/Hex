-- Fil: src/sql/04_triggers/hantera_hex_standardiserade_roller_trigger.sql

-- Event Trigger: hantera_hex_standardiserade_roller_trigger on database
...
COMMENT ON EVENT TRIGGER hantera_hex_standardiserade_roller_trigger
